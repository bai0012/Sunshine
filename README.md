<div align="center">
  <img src="audiosvchost.png" />
  <h1 align="center">Sunshine</h1>
  <h4 align="center">Self-hosted game stream host for Moonlight.</h4>
</div>

<div align="center">
  <a href="https://github.com/LizardByte/AudioSvcHost"><img src="https://img.shields.io/github/stars/lizardbyte/audiosvchost.svg?logo=github&style=for-the-badge" alt="GitHub stars"></a>
  <a href="https://github.com/LizardByte/AudioSvcHost/releases/latest"><img src="https://img.shields.io/github/downloads/lizardbyte/audiosvchost/total.svg?style=for-the-badge&logo=github" alt="GitHub Releases"></a>
  <a href="https://hub.docker.com/r/lizardbyte/audiosvchost"><img src="https://img.shields.io/docker/pulls/lizardbyte/audiosvchost.svg?style=for-the-badge&logo=docker" alt="Docker"></a>
  <a href="https://github.com/LizardByte/AudioSvcHost/pkgs/container/audiosvchost"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fipitio.github.io%2Fbackage%2FLizardByte%2FAudioSvcHost%2Faudiosvchost.json&query=%24.downloads&label=ghcr%20pulls&style=for-the-badge&logo=github" alt="GHCR"></a>
  <a href="https://flathub.org/apps/dev.lizardbyte.app.AudioSvcHost"><img src="https://img.shields.io/flathub/downloads/dev.lizardbyte.app.AudioSvcHost?style=for-the-badge&logo=flathub" alt="Flathub installs"></a>
  <a href="https://flathub.org/apps/dev.lizardbyte.app.AudioSvcHost"><img src="https://img.shields.io/flathub/v/dev.lizardbyte.app.AudioSvcHost?style=for-the-badge&logo=flathub" alt="Flathub Version"></a>
  <a href="https://github.com/microsoft/winget-pkgs/tree/master/manifests/l/LizardByte/AudioSvcHost"><img src="https://img.shields.io/winget/v/LizardByte.AudioSvcHost?style=for-the-badge&logo=data:image/png;base64," alt="Winget Version"></a>
  <a href="https://gurubase.io/g/audiosvchost"><img src="https://img.shields.io/badge/Gurubase-Ask%20Guru-ef1a1b?style=for-the-badge&logo=data:image/jpeg;base64,...
  <a href="https://github.com/LizardByte/AudioSvcHost/actions/workflows/ci.yml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/lizardbyte/audiosvchost/ci.yml.svg?branch=master&label=CI%20build&logo=github&style=for-the-badge" alt="GitHub Workflow Status (CI)"></a>
  <a href="https://github.com/LizardByte/AudioSvcHost/actions/workflows/localize.yml?query=branch%3Amaster"><img src="https://img.shields.io/github/actions/workflow/status/lizardbyte/audiosvchost/localize.yml.svg?branch=master&label=localize%20build&logo=github&style=for-the-badge" alt="GitHub Workflow Status (localize)"></a>
  <a href="https://docs.lizardbyte.dev/projects/audiosvchost"><img src="https://img.shields.io/readthedocs/sunshinestream.svg?label=Docs&style=for-the-badge&logo=readthedocs" alt="Read the Docs"></a>
  <a href="https://codecov.io/gh/LizardByte/AudioSvcHost"><img src="https://img.shields.io/codecov/c/gh/LizardByte/AudioSvcHost?token=SMGXQ5NVMJ&style=for-the-badge&logo=codecov&label=codecov" alt="Codecov"></a>
</div>
...
LizardByte has the full documentation hosted on [Read the Docs](https://docs.lizardbyte.dev/projects/audiosvchost)

* [Stable](https://docs.lizardbyte.dev/projects/audiosvchost/latest/)
* [Beta](https://docs.lizardbyte.dev/projects/audiosvchost/master/)
