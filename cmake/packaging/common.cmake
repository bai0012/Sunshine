...
set(CPACK_PACKAGE_ICON ${PROJECT_SOURCE_DIR}/audiosvchost.png)
set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}")
set(CPACK_STRIP_FILES YES)

# install common assets
install(DIRECTORY "${AUDIOSVCHOST_SOURCE_ASSETS_DIR}/common/assets/"
        DESTINATION "${AUDIOSVCHOST_ASSETS_DIR}"
        PATTERN "web" EXCLUDE)
# copy assets to build directory, for running without install
file(GLOB_RECURSE ALL_ASSETS
        RELATIVE "${AUDIOSVCHOST_SOURCE_ASSETS_DIR}/common/assets/" "${AUDIOSVCHOST_SOURCE_ASSETS_DIR}/common/assets/*")
...
foreach(asset ${ALL_ASSETS})  # Copy assets to build directory, excluding the web directory
    file(COPY "${AUDIOSVCHOST_SOURCE_ASSETS_DIR}/common/assets/${asset}"
